...
class page():
    def switch(self):
        ...
        self.title_label = ttk.Label(self, text = "Timer",font = ("Arial",40,"bold"))
        ...
        self.colon_label1 = ttk.Label(self, text = ":",font = ("Arial",90,"bold"))
        self.colon_label1.place(x=292,y=195,anchor="center")
        self.colon_label2 = ttk.Label(self, text = ":",font = ("Arial",90,"bold"))
        self.colon_label2.place(x=459,y=195,anchor="center")

        self.hourEntry= ttk.Entry(self, width=2, font=("Arial",100,"bold"), #text field
        ...
        self.minuteEntry= ttk.Entry(self, width=2, font=("Arial",100,"bold"), #text field
                        textvariable=self.minute)
        self.minuteEntry.place(x=375,y=200,anchor="center")
        self.minute_label = ttk.Label(self, text = "(Mintues)",font = ("Arial",10))
        self.minute_label.place(x=375,y=125,anchor="center")

        self.secondEntry= ttk.Entry(self, width=2, font=("Arial",100,"bold"), #text field
                    textvariable=self.second)
        self.secondEntry.place(x=480,y=200,anchor="w")
        self.second_label = ttk.Label(self, text = "(Seconds)",font = ("Arial",10))
        self.second_label.place(x=545,y=125,anchor="center")

        self.remindervar=tk.StringVar()
        self.remindervar.set("")
        self.reminder_label = ttk.Label(self, textvariable = self.remindervar,font = ("Arial",16,"bold"))
